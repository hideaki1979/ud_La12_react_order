...
import { edit, index, update } from "@/actions/App/Http/Controllers/OrderController";
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: '注文編集', href: edit.url(order.id) }
            ]}
        >
            <Head title="注文編集" />
            <div className="py-12">
